...
Implementation choices should be checked against current primary project/vendor documentation. Conceptual articles inform the design but do not override tested product behavior.

## Architecture and data mesh
...
- [Azure Event Hubs Kafka protocol support](https://learn.microsoft.com/en-us/azure/event-hubs/azure-event-hubs-apache-kafka-overview)
